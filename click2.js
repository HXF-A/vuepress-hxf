...
document.getElementsByClassName("global-ui")[0].appendChild(canvas)
...
canvas.style.left = ((window.innerWidth ) - maxx) / 2 + 'px';
canvas.style.top = ((window.innerHeight ) - maxy) / 2 + 'px';
